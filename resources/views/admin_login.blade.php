...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
	...
	<!-- font-awesome icons -->
	<link rel="stylesheet" href="c{{asset('public/backend/ss/font.css')}}" type="text/css" />
	...
	<div class="log-w3">
		<div class="w3layouts-main">
			...
			<form action="{{URL::to('/admin-dashboard')}}" method="post">
				{{ csrf_field() }}
				<input type="text" class="text" name="admin_email" placeholder="Enter your email address or phone number" required="">
