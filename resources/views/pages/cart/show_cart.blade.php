					...
					<tbody>
						...
						<tr>
							...
							<td class="cart_description">
								...
								<p>Web ID: {{ $content_value->id }}</p>
							</td>
							<td class="cart_price">
								<p>{{ number_format($content_value->price).' '.'VND' }}</p>
							</td>
							...
							<td class="cart_total">
								<p class="cart_total_price">{{ number_format($content_value->price*$content_value->qty).' '.'VND' }}</p>
							</td>
							<td class="cart_delete">
								<a class="cart_quantity_delete" href="{{URL::to('/delete-to-cart/'.$content_value->rowId)}}"><i class="fa fa-times"></i></a>
                            </td>
                        </tr>
                        @endforeach
					</tbody>
				...
				<div class="col-sm-6">
					<div class="total_area">
						<ul>
							...
							<li>Shipping Cost <span>Free Ship</span></li>
