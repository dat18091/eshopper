...
<body>
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								...
								<li><a href="{{URL::to('/checkout')}}" class="active"><i class="fa fa-crosshairs"></i> Checkout</a></li>
				...
				<div class="col-sm-4">
					<div class="signup-form"><!--sign up form-->
						...
						{{ csrf_field() }}
							...
							<input type="text" name="customer_gender" placeholder="Gender"/>
							<input type="text" name="customer_age" placeholder="Age"/>
    ...
    <script src="{{asset('public/frontend/js')}}"></script>
	<script src="{{asset('public/frontend/js/bootstrap.min.js')}}"></script>
    <script src="{{asset('public/frontend/scrollUp.min.js')}}"></script>
    <script src="{{asset('public/frontend/prettyPhoto.js')}}"></script>
