        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <form class="form-horizontal bucket-form" method="post" action="{{URL::to('/save-category-product')}}">
                    ...
                    <div class="form-group"><!-- Category Product Name -->
                    ...
                    <div class="form-group"><!-- Category Product Parent -->
                        ...
                        <div class="col-lg-6">
                            <select name="category_product_parent" class="form-control m-bot15">
                                @foreach($category_product_parent as $key => $parent)
                    ...
                    <div class="form-group "><!-- Category Product Description --> 
                    ...
                    <div class="form-group"><!-- Category Product Status -->
